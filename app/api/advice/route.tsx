...
import Advices from '@/lib/advices_365.json'
...
export async function GET() {
  try {
    ...
    return new NextResponse(JSON.stringify(randomAdvice), {
      headers: { "Content-Type": "application/json" }
    });
  } catch (error: any) {
    return new NextResponse("Error in fetching advice: " + error.message, {
      status: 500
    });
  }
}

...
export function Robot2(props: any) {
  const group = useRef()
                ...
                <group name="Env">
                  <group
                    ...
                    <mesh
                      ...
                      castShadow
                      receiveShadow
                      geometry={(nodes.Scheibe_Boden_0 as THREE.Mesh).geometry}
                    ...
                    <group name="D_MassPoint" position={[0, 0, 77.5]}>
                      <group
                        ...
                        <mesh
                          ...
                          castShadow
                          receiveShadow
                          geometry={(nodes.Drone_Body_body_0 as THREE.Mesh).geometry}
                        ...
                        <group name="Drone_leg_F" position={[0, -38.681, 20.012]}>
                          <mesh
                            ...
                            castShadow
                            receiveShadow
                            geometry={(nodes.Drone_leg_F_leg_0 as THREE.Mesh).geometry}
                          ...
                          <group
                            ...
                            <mesh
                              ...
                              castShadow
                              receiveShadow
                              geometry={(nodes.F_P1_G_leg_0 as THREE.Mesh).geometry}
                              material={materials.material}
                            />
                            <group name="F_P2" rotation={[Math.PI / 2, 0.087, -Math.PI / 2]}>
                              <mesh
                                ...
                                castShadow
                                receiveShadow
                                geometry={(nodes.F_P2_leg_0 as THREE.Mesh).geometry}
                                material={materials.material}
                              />
                              <group name="F_P3_G" position={[0, -22.916, 0.027]}>
                                <mesh
                                  ...
                                  castShadow
                                  receiveShadow
                                  geometry={(nodes.F_P3_G_leg_0 as THREE.Mesh).geometry}
                                  material={materials.material}
                                />
                                <group name="F_P4" rotation={[1.222, 0, Math.PI]}>
                                  <mesh
                                    ...
                                    castShadow
                                    receiveShadow
                                    geometry={(nodes.F_P4_leg_0 as THREE.Mesh).geometry}
                                    material={materials.material}
                                  />
                                  <group name="F_P5_M" position={[-0.016, -11.283, 0.082]}>
                                    <mesh
                                      ...
                                      castShadow
                                      receiveShadow
                                      geometry={(nodes.F_P5_M_leg_0 as THREE.Mesh).geometry}
                                      material={materials.material}
                                    />
                                    <group name="F_P6_G" position={[0.005, -9.326, -0.082]}>
                                      <mesh
                                        ...
                                        castShadow
                                        receiveShadow
                                        geometry={(nodes.F_P6_G_leg_0 as THREE.Mesh).geometry}
                                        material={materials.material}
                                      />

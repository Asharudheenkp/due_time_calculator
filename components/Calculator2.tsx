...
const shifts = [
  ...
  { value: 3, label: "10:00 AM - 07:00 PM" },
...
const Calculator2 = () => {
  ...
  const calculateShiftTimes = (
    ...
    const workMaxTimeLimits = [
      ...
      {
        end: new Date(currentTime.setHours(19, 10, 0)),
        start: new Date(currentTime.setHours(19, 0, 0)),
      },
    ];
              ...
              <p>
                {showShift === 3 && (
                  <>
                    ...
                    {isOverTime2 && (
                      <>
                        {`The over time to 7:10 PM: ${timeInfo.overTimeToMax} `}
                        <br />
                      </>
                    )}
                    {isDueTime && (
                      <>
                       <span className="text-red-500 font-bold">{`The due time to 7:00 PM: ${timeInfo.dueTimeToMin} `}</span>
                        <br />
                      </>
                    )}
                    {isDueTime2 && (
                      <>
                         <span className="text-red-500 font-bold">{`The due time to 7:10 PM: ${timeInfo.dueTimeToMax} `}</span>
                        <br />
                      </>
                    )}
                  </>
